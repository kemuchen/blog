...
public class CommonMoldGetController {
    ...
    @PutMapping("dynamicDict")
    public ApiResponseResultEntity getDynamicDict(@RequestBody SysDynamicDictConfigEntity sysDynamicDictConfigEntity) throws AppException {
