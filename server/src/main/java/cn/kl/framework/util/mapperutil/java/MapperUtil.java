...
import cn.kl.framework.util.date.DateUtil;
...
public class MapperUtil {
    ...
    private static Map<String, Object> formatTable(Map<String, Object> table) {
        ...
        for (Map<String, Object> column : columns) {
            ...
            switch (column_type) {
                case "int": column.put("column_java_type", "Integer"); break;
                case "double": column.put("column_java_type", "Double"); break;
                case "decimal": column.put("column_java_type", "BigDecimal"); break;
                case "bigint": column.put("column_java_type", "long"); break;
                case "date":
                case "datetime": column.put("column_java_type", "Date"); break;
                default: column.put("column_java_type", "String");
            }
        }
        return table;
    }
