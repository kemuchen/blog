...
import cn.kl.framework.common.dao.auto.mapper.SysDynamicDictConfigMapper;
import cn.kl.framework.common.dao.customize.mapper.CustomizeSysLoginHistoryMapper;
...
import cn.kl.framework.system.dao.customize.mapper.CustomizeSysCommonMapper;
...
public class BusinessCommonServiceImplements implements BusinessCommonServiceInterface {
    ...
    public ApiResponseResultEntity getDynamicDict(SysDynamicDictConfigEntity sysDynamicDictConfigEntity) throws AppException {
        ...
        try {
            String params = sysDynamicDictConfigEntity.getParams();
            /**
