...
public interface ${table_name_upper}Mapper {
     ...
     * @return void
     **/
    void insert${table_name_upper}(Map<String, Object> params);
     ...
     * @return void
     **/
    void update${table_name_upper}(Map<String, Object> params);
     ...
     **/
    Map<String, Object> select${table_name_upper}ById(String id);
     ...
     **/
    List<Map<String, Object>> get${table_name_upper}s(Map<String, Object> params);
     ...
     **/
    Integer get${table_name_upper}sCount(Map<String, Object> params);
}